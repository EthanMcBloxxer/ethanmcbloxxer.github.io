-- If this is inspected note that this is not used or displayed at any time during gameplay.
-- The following words are to be moderated when submitting user input as TextService:ModerateStringAsync is somewhat hard to use.

local GoogleBadWords = 
{
	"anal",
	"anus",
	"arse",
